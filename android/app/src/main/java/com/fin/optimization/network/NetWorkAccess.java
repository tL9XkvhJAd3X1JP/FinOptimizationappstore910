...
import com.fin.optimization.bean.BaseBean;
...
//        return "http://192.168.10.190:8765"+url;
...
//                        MainApplication.getApp().startActivity(new Intent(MainApplication.getApp(), LoginActivity.class).putExtra("finishAll", true));
                        Intent intent = new Intent(MainApplication.getApp(), MyReactActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putString("object", "finishOther");
                        intent.putExtras(bundle);
                        MainApplication.getApp().setReactModuleName(Constants.ReactName.LOGIN);
