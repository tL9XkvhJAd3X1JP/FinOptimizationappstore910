...
import com.fin.optimization.bean.StringBean;
import com.fin.optimization.bean.UserBean;
...
import com.fin.optimization.utils.MapRemoveNullUtil;
...
public class GsonRequest<T> extends Request<T> {
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        ...
        if (isStream) {
            ...
            header.put("token", new MyPreferenceManager().getRequestToken());
