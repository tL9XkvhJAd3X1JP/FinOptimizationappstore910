...
-(void)setUpAllChildViewController{
    ...
    homeVC = [[OneViewController alloc] init];
    [self setupChildViewController:homeVC title:@"展示" imageName:@"icon_tabbar_onsite" seleceImageName:@"icon_tabbar_onsite_selected"];
    homeVC = [[OneViewController alloc] init];
    [self setupChildViewController:homeVC title:@"消息" imageName:@"icon_tabbar_merchant_normal" seleceImageName:@"icon_tabbar_merchant_selected"];
    LogViewController *log= [[LogViewController alloc] init];
    [self setupChildViewController:log title:@"我的" imageName:@"icon_tabbar_mine" seleceImageName:@"icon_tabbar_mine_selected"];
...
//    RootNavigationController *nav = [[RootNavigationController alloc]initWithRootViewController:controller];
    MyRootNavigationController *nav = [[MyRootNavigationController alloc]initWithRootViewController:controller];
