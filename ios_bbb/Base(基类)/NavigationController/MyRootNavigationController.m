...
@interface MyRootNavigationController ()<UINavigationControllerDelegate,UIGestureRecognizerDelegate>
...
- (void)viewDidLoad {
    ...
    self.popRecognizer = [[UIScreenEdgePanGestureRecognizer alloc] initWithTarget:self action:@selector(handleNavigationTransition:)];
    //下面是全屏返回
...
#pragma mark- UINavigationControllerDelegate navigation切换是会走这个代理  self.delegate = self;
...
{
    NSLog(@"didShowViewController %d",_isSystemSlidBack);
