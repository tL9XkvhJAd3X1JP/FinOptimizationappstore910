...
@interface TSTimeLocateViewOne : UIActionSheet<UIPickerViewDelegate, UIPickerViewDataSource,CAAnimationDelegate> {
    int currentYear;
}
...
@property (strong, nonatomic) NSString *hourContent;
@property (strong, nonatomic) NSString *minuteContent;
@property (assign, nonatomic) BOOL hiddenHourAndMinute;
