...
+ (void)showNotHideTipMessageInWindow:(NSString*)message
{
    [self showCustomTipMessage:message isWindow:true];
}
...
+ (void)showCustomTipMessage:(NSString*)message isWindow:(BOOL)isWindow
{
    MBProgressHUD *hud = [self createMBProgressHUDviewWithMessage:message isWindiw:isWindow];
    hud.mode = MBProgressHUDModeText;
//    [hud hideAnimated:YES afterDelay:hideTime];
...
+ (void)showCustomInfoNotHideMessage:(NSString *)Message
{
//    [self showCustomIconInWindow:@"MBHUD_Info" message:Message];
    [self showNotHideCustomIcon:@"MBHUD_Info" message:Message isWindow:YES];
}
...
+ (void)showNotHideCustomIcon:(NSString *)iconName message:(NSString *)message isWindow:(BOOL)isWindow
{
    MBProgressHUD *hud  =  [self createMBProgressHUDviewWithMessage:message isWindiw:isWindow];
    hud.customView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:iconName]];
    hud.mode = MBProgressHUDModeCustomView;
