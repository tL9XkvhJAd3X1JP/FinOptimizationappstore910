...
#define PASSWORD @"ihlih*0039JOHT$)(PIJY*(()JI^)IO%"

static const char encodingTable[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
const NSUInteger kAlgorithmKeySize256 = kCCKeySizeAES256;
const NSUInteger kAlgorithmKeySize128 = kCCKeySizeAES128;
...
+ (NSData *)AESKeyForPassword:(NSString *)password{                  //Derive a key from a text password/passphrase
    ...
    NSMutableData *derivedKey = [NSMutableData dataWithLength:kAlgorithmKeySize256];
...
+ (NSString *)AES128EncryptWithPlainText:(NSString *)plain
{
    ...
    char keyPtr[kAlgorithmKeySize128+1]; // room for terminator (unused)
    ...
    CCCryptorStatus cryptStatus = CCCrypt(kCCEncrypt, kCCAlgorithmAES128,kCCOptionPKCS7Padding,
                                          [[NSData AESKeyForPassword:PASSWORD] bytes], kAlgorithmKeySize128,
