...
- (void)viewDidLoad {
    //    _progressViewColor = [UIColor colorWithHexString:@"0485d1"];
    //    self.url = [self.viewDic objectForKey:@"url"];
...
-(void)backButtonClicked
{
    if ([self.webView canGoBack]) {
        ...
        [super leftNavBtnPressed:[NSNull null]];
