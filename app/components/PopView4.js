...
//使用方法
//1.导入import PopView4 from "../components/PopView4";
//2.<PopView4 ref = 'PopView4'></PopView4>  写在render(){}最外层的<View>内
//3.类内加入回调方法
//PopView4=(item)=>
//{
//    alert(this.refs.PopView4.selectedItem);
//}
//4.显示弹框调用this.refs.PopView4.setState({isHiden:false,actionView:this,title:"选择列表",data:["百度地图","高德地图","腾讯地图"],selectedIndex:0,});
//
//选择列表，有默认项 //PureComponent Component
export default class PopView4 extends PureComponent {
    constructor(props){
        super(props);
        //initialProps
...
//                onScroll={this.onScroll}
    ...
    renderRow = ({item,index}) =>{
        return (
                ...
                <View style={this.selectedOnItem(index)}>
    ...
    //更换界面样式的逻辑代码
    selectedOnItem=(index)=>{
        if(index === this.state.selectedIndex)
        {
            return styles.container_item_sel;
        }
        else
        {
            return styles.container_item;
        }
    }
...
//        this.selectedItem = item;
        ...
        {
            //点确定回调的方法
            this.state.actionView.popOkClick4(item,index);
        }
        this._hideView();
    }
}
